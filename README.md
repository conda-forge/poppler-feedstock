...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/poppler-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/poppler-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add poppler poppler-qt
# for installing globally
pixi global install poppler poppler-qt
```
...
It is possible to list all of the versions of `poppler` available on your platform:
...
```
pixi search poppler --channel conda-forge
```
